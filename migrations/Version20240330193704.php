...
final class Version20240330193704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_attribute (id INT AUTO_INCREMENT NOT NULL, attribute_code VARCHAR(60) NOT NULL, attribute_value VARCHAR(60) NOT NULL, worker_id INT NOT NULL, INDEX IDX_3D1A3DCB6B20BA36 (worker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
