...
final class Version20240331181435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer_photo (id INT AUTO_INCREMENT NOT NULL, file_name VARCHAR(255) NOT NULL, real_file_name VARCHAR(255) NOT NULL, olx_id INT NOT NULL, offer_id INT NOT NULL, INDEX IDX_979AF9F153C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
