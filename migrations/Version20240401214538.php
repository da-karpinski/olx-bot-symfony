...
final class Version20240401214538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE integration (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, integration_type_id INT NOT NULL, INDEX IDX_FDE96D9BA76ED395 (user_id), INDEX IDX_FDE96D9BA86036CA (integration_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE integration_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(60) NOT NULL, integration_code VARCHAR(60) NOT NULL, enabled TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE worker_integration (id INT AUTO_INCREMENT NOT NULL, worker_id INT NOT NULL, integration_id INT NOT NULL, INDEX IDX_3461715C6B20BA36 (worker_id), INDEX IDX_3461715C9E82DDEA (integration_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
